...
public class ConditionalModelRules extends BaseRules {
    ...
    public boolean generateBaseRecordClass() {
        return introspectedTable.getBaseColumns().size() > 0 || introspectedTable.getPrimaryKeyColumns()
                                                                                 .size() == 1 || (introspectedTable.getBLOBColumns()
                                                                                                                   .size() > 0 && !generateRecordWithBLOBsClass());
